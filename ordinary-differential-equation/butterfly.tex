...
4次のAdams-Bashforth法及び4次のAdams-Moulton法は式\eqref{eq:ab}, \eqref{eq:am}の通りである. 
...
\begin{align}
  ...
  \label{eq:am}
\end{align}
また式\eqref{eq:ab}, \eqref{eq:am}を用いた予測子・修正子法は式\eqref{eq:q2}の通りである. 
...
計算次数の漸近の様子は図\ref{fig:q3}の通りであるで, 最終的な計算次数は表\ref{tab:q3}の通りである.
